"""
Django settings for IdleRagnarok project.
...
ROOT_URLCONF = 'IdleRagnarok.urls'
...
WSGI_APPLICATION = 'IdleRagnarok.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'req_files/static'),
]
